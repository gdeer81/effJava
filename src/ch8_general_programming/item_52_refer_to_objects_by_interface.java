...
public class item_52_refer_to_objects_by_interface {
    ...
    // We have a method that consumes a Collection
    static void consumeCollection(Collection<String> list) {
        for(String s : list) {
            System.out.println("...processing : " + s);
        }
    }
    // We have an inferior method that consumes an ArrayList
    ...
    static void consumeCollectionBadly(ArrayList<String> list) {
        for(String s : list) {
            System.out.println("...processing : " + s);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        // If we try using our inferior method on each collection, we would have to cast each collection
        System.out.println("***Processing ArrayList with consumeCollectionBadly");
        consumeCollectionBadly(arrayList);
